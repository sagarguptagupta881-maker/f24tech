        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div class="bg-gray-50 rounded-2xl p-8">
                ...
                <form action="api/contact.php" method="POST" class="space-y-6">
                    ...
                    <button
                        type="submit"
                        class="w-full bg-blue-600 text-white px-6 py-4 rounded-lg font-semibold hover:bg-blue-700 transition-all duration-300 flex items-center justify-center group shadow-lg hover:shadow-xl"
                    >
                        Send Message
                ...
                <div class="space-y-6 mb-12">
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-blue-600 font-medium mb-1">sales@f24tech.com</p>
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-blue-600 font-medium mb-1">+91 8950773419</p>
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-blue-600 font-medium mb-1">Plot No. 44, Sector 44, Gurgaon, Haryana, 122003, INDIA</p>
